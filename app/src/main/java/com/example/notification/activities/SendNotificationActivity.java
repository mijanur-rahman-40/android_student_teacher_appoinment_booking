...
import com.example.notification.Api;
...
public class SendNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ModelStudent modelStudent = (ModelStudent) getIntent().getSerializableExtra("modelStudent");
        ...
        textView.setText("Sending to : " + modelStudent.getEmail());


        findViewById(R.id.buttonSend).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendNotification(modelStudent);
            }
        });
    ...
    private void sendNotification(ModelStudent modelStudent) {
        ...
        Call<ResponseBody> call = api.sendNotification(modelStudent.getToken(), title, body);
